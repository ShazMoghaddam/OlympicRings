...
Circular geometry using equal aspect ratio

Overlapping layout to resemble the official symbol

The focus of this project is basic data visualization, plotting, and geometric positioning in Python rather than graphical perfection.
...
matplotlib.patches.Circle is used to draw ring outlines

Axes are removed for a clean visual output
